...
/* main function */
//TODO: create default working directory
//TODO: get working directory along with filename
...
int main(int argc, char *argv[])
{
    ...
    gtk_window_set_title(GTK_WINDOW(window), "Co - Code (Insert file name)");
    gtk_window_set_default_size(GTK_WINDOW(window), 700, 500); /* window size y & x values */
